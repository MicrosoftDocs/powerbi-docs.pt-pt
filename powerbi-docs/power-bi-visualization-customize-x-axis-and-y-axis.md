---
title: Personalizar as propriedades dos eixos X e Y (Tutorial)
...
---
# <a name="customize-x-axis-and-y-axis-properties-tutorial"></a>Personalizar as propriedades dos eixos X e Y (Tutorial)
...
2. Ative e desative o eixo Y ao selecionar o controlo de deslize Ativar (ou Desativar). Por enquanto, deixe-o em **Ligado**.  Uma razão para querer desativar o eixo X é poupar espaço para obter mais dados.
...
3. Em janeiro, a percentagem de Margem Bruta foi de 35%, chegando ao máximo de 45% em abril, caindo em julho e chegando ao máximo novamente em agosto. Será que vamos ver um padrão semelhante nas vendas do ano passado e deste ano?
4. Adicione **Vendas Deste Ano > Valor** e **Vendas do Ano Passado** ao gráfico de linhas. A escala de **% de Margem Bruta do Ano Passado** (alinha azul ao longo da linha de grelha 0M%) é muito menor do que a escala de **Vendas**, o que dificulta a comparação. As percentagens das etiquetas do eixo Y são ridículas.      
