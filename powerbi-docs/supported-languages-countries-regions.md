...
O serviço Power BI (no browser) está disponível nos seguintes 42 idiomas:
...
Há duas formas de obter o Power BI Desktop: Pode transferi-lo ou instalá-lo da Loja Windows.

* Quando [instalar o Power BI Desktop da Loja Windows](#choose-a-language-for-power-bi-desktop-installed-from-the-windows-store), este instala todos os idiomas e mostra o idioma que corresponde ao idioma predefinido do Windows.
* Quando [transfere o Power BI Desktop](#choose-a-language-when-you-download-power-bi-desktop), escolhe o idioma. 
* Também pode [selecionar uma região para utilizar ao importar dados](#choose-the-locale-to-be-used-when-importing-data-into-power-bi-desktop) de um relatório específico. 

### <a name="choose-a-language-for-power-bi-desktop-installed-from-the-windows-store"></a>Selecionar um idioma para o Power BI Desktop instalado da Loja Windows
1. [Instale o Power BI Desktop](http://aka.ms/pbidesktopstore) a partir da Loja Windows.
...
### <a name="choose-a-language-when-you-download-power-bi-desktop"></a>Selecionar um idioma ao transferir o Power BI Desktop
O idioma que selecionou para o Power BI Desktop afeta o formato de apresentação dos números e datas nos relatórios. 

* Selecione um idioma ao [transferir o Power BI Desktop](https://powerbi.microsoft.com/desktop). 

Para alterar o idioma do Power BI Desktop, regresse à página de transferências e transfira-o num idioma diferente.

### <a name="choose-the-locale-to-be-used-when-importing-data-into-power-bi-desktop"></a>Selecionar a região a utilizar ao importar dados para o Power BI Desktop
...
3. Na caixa **Região**, selecione uma região diferente. 
   
   ![Caixa de diálogo Opções do Power BI Desktop](media/supported-languages-countries-regions/pbi_supptdlangs_locale.png)
4. Selecione **OK**.
...
* Está a utilizar uma das aplicações móveis do Power BI? Consulte os [Idiomas suportados nas aplicações móveis do Power BI](mobile-apps-supported-languages.md) para obter detalhes.
