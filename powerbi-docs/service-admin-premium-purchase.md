...
- Utilizar SKUs P para cenários de produção típicos. Os SKUs P exigem um compromisso mensal ou anual e são faturados mensalmente. Pode comprar SKUs P no [centro de administração do Microsoft 365](https://admmin.microsoft.com).
...
- Ativar a incorporação do Power BI em aplicações de terceiros. Para obter mais informações, veja [Power BI Embedded](developer/azure-pbie-what-is-power-bi-embedded.md).
