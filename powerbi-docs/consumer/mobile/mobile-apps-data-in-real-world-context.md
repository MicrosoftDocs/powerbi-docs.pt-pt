...
* [Scanning a QR code with the Power BI for Mixed Reality app](./mobile-hololens2-app.md#open-reports-with-qr-codes) (Ler um código QR com a aplicação Power BI for Mixed Reality).
