...
:::image type="content" source="media/end-user-personalize-visuals/personalize-drag-and-drop.png" alt-text="Captura de ecrã de arrastar um campo num elemento visual.":::

Também pode reordenar rapidamente as colunas de uma tabela ou matriz.

:::image type="content" source="media/end-user-personalize-visuals/personalize-reorder-columns.png" alt-text="Captura de ecrã da reordenação de colunas numa tabela.":::
