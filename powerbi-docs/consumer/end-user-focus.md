...
![dashboard no modo de ecrã inteiro, antes e depois](media/end-user-focus/power-bi-full-screen-comparison.png)
...
![dashboard no modo de ecrã inteiro, antes e depois](media/end-user-focus/power-bi-focus-compare.png)
...
![Menu para dashboards](media/end-user-focus/power-bi-full-screen-menu-dashboard.png)    

Menu para páginas de relatório    
![Menu para relatórios](media/end-user-focus/power-bi-report-menu.png)    
  ...
  * ![Ícone Ajustar ao ecrã](media/end-user-focus/power-bi-fit-to-width.png)    
...
2. Paire o cursor sobre um mosaico do dashboard ou sobre uma visualização de mosaico, selecione as reticências (…) e escolha **Abrir no modo de detalhe**.
    ...
    ![menu de reticências do mosaico](media/end-user-focus/power-bi-dashboard-focus-mode.png).
...
2. Paire o cursor sobre o gráfico de área no canto inferior esquerdo e selecione o ícone **modo de detalhe** ![ícone do modo de detalhe](media/end-user-focus/pbi_popout.jpg).  
...
3. Como alternativa, expanda o painel Filtros para interagir com todos os filtros aplicados a este elemento visual. Explore os dados em busca de novas informações e respostas a perguntas. Como *consumidor*, não pode adicionar novos filtros, alterar os campos utilizados nas visualizações nem criar novas visualizações.  No entanto, todas as alterações feitas nos filtros existentes são guardadas quando sair do Power BI. Se não quiser que o Power BI se lembre das suas modificações, selecione **Repor para predefinição**. ![botão reverter para predefinição](media/end-user-focus/power-bi-resets.png)  
   ...
   ![modo de detalhe com o ecrã Filtros](media/end-user-focus/power-bi-display-focus-filters3.png)
