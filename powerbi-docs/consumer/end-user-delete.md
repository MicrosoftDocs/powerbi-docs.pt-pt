...
2. Procure o dashboard a eliminar e selecione o ícone Eliminar ![ícone Eliminar](./media/end-user-delete/power-bi-delete-icon.png).

    ![vídeo](./media/end-user-delete/power-bi-delete-dash.gif)
...
2. Procure o relatório a eliminar e selecione o ícone Eliminar   ![ícone Eliminar](./media/end-user-delete/power-bi-delete-icon.png).   

    ![separador relatórios da área de trabalho](./media/end-user-delete/power-bi-delete-reportnew.png)
3. Confirme a eliminação.

   ![Caixa de diálogo Eliminar relatório](./media/end-user-delete/power-bi-delete-report.png)
...
2. Procure o livro a eliminar e selecione o ícone Eliminar ![ícone Eliminar](./media/end-user-delete/power-bi-delete-report2.png) .

    ![Separador Livros](./media/end-user-delete/power-bi-delete-workbooknew.png)
3. Confirme a eliminação.

   ![Caixa de diálogo Remover livro](./media/end-user-delete/power-bi-delete-confirm.png)
...
2. Procure o conjunto de dados para eliminar e selecione as reticências (...).  
    ...
    ![Separador Conjuntos de Dados](./media/end-user-delete/power-bi-delete-datasetnew.png)
3. No menu pendente, selecione **Eliminar**.

   ![menu de reticências](./media/end-user-delete/power-bi-delete-datasetnew2.png)
4. Confirme a eliminação.

   ![Caixa de diálogo Eliminar dashboard](./media/end-user-delete/power-bi-delete-dataset-confirm.png)
...
1. Na navegação à esquerda, selecione **Áreas de trabalho**
    ...
    ![Áreas de trabalho de aplicações](./media/end-user-delete/power-bi-delete-workspace.png)
2. Selecione as reticências (...) à direita da área de trabalho a ser eliminada e selecione **Editar área de trabalho**.

   ![menu de reticências > Editar área de trabalho](./media/end-user-delete/power-bi-edit-workspace.png)
3. Na janela **Editar área de trabalho**, selecione **Eliminar área de trabalho** > **Eliminar**.

    ![eliminar área de trabalho](./media/end-user-delete/power-bi-delete-workspace2.png)
...
2. No canto superior direito, selecione as reticências (...) e selecione **Sair da área de trabalho** > **Sair**.
      ...
      ![sair da área de trabalho](./media/end-user-delete/power-bi-leave-workspace.png)
...
2. Passe o cursor sobre a aplicação para eliminar e selecione o ícone Eliminar ![](./media/end-user-delete/power-bi-delete-report2.png).

   ![Selecionar aplicações](./media/end-user-delete/power-bi-delete-app.png)

   Se remover uma aplicação acidentalmente, terá diversas opções para recuperá-la.  Pode pedir ao criador da aplicação que volte a enviá-la, pode procurar o e-mail original com a ligação para a aplicação, pode ver o seu [centro de Notificações](end-user-notification-center.md) para saber se a notificação dessa aplicação ainda aparece na lista ou pode consultar o [AppSource](end-user-apps.md) da sua organização.
...
* [Remover o seu dashboard em Destaque](end-user-featured.md#change-the-featured-dashboard)
* [Remover um dashboard (remover dos favoritos)](end-user-favorite.md)
* [Eliminar uma página de relatório](end-user-delete.md)
* [Eliminar um mosaico de dashboard](../service-dashboard-edit-tile.md)
* [Eliminar uma visualização de relatório](end-user-delete.md)
