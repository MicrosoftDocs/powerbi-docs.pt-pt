...
3. Abra o **painel** *Favoritos* ao selecionar **Favoritos** no painel de navegação esquerdo ou ao selecionar o ícone de estrela ![](media/end-user-experience/powerbi-star-icon.png).
