...
Para apresentar essa mesma visualização sem a distração de barras de menus, do painel de filtro e de outro cromado, selecione o ícone **Ecrã Inteiro** na barra de menus superior ![ícone de ecrã inteiro](media/end-user-reading-view/power-bi-focus-icon.png).
