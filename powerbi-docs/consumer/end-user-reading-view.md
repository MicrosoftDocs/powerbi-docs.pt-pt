...
description: Neste guia de início rápido, os **consumidores** irão ficar a saber mais sobre o Power BI, as aplicações, os relatórios e os dashboards.
author: mihart
ms.author: mihart
services: powerbi
documentationcenter: ''
...
ms.locfileid: "96390179"
---
# <a name="quickstart-learn-about-the-power-bi-capabilities-for-business-users"></a>Guia de Início Rápido: saiba mais sobre as funcionalidades do Power BI para *utilizadores empresariais*
...
![Captura de ecrã que ilustra o Power BI a obter conteúdos de várias origens e a emitir um relatório.](./media/end-user-reading-view/power-bi-concept.png)
...
![Captura de ecrã a mostrar o ecrã Aplicações com oito aplicações diferentes.](./media/end-user-reading-view/power-bi-app.png)
...
![Imagem a mostrar o mesmo relatório num telemóvel e num browser de computador.](./media/end-user-reading-view/power-bi-report-phone.png)
...
![Imagem a mostrar o mesmo dashboard apresentado num ecrã do browser de computador ou telemóvel.](./media/end-user-reading-view/power-bi-dashboard-phone.png)

Para saber como ver os dashboards, veja [Dashboards do Power BI](end-user-dashboards.md)
 
## <a name="interact-in-the-power-bi-service"></a>Interagir no serviço Power BI
...
![vídeo de comentário](./media/end-user-reading-view/comment.gif)

Saiba mais sobre [comentários](end-user-comment.md)

### <a name="sit-back-and-let-power-bi-work-for-you"></a>Descontraia e deixe que o Power BI trabalhe por si
...
![selecionar o ícone Subscrever](./media/end-user-reading-view/power-bi-subscribe-and-email.png)

 Saiba mais sobre as [subscrições do Power BI](end-user-subscribe.md)

#### <a name="get-alerts-when-your-data-reaches-a-threshold"></a>Obter alertas quando os dados atingirem um limiar
...
![Perguntas e Respostas](./media/end-user-reading-view/power-bi-q-and-a-funnel.png)
...
![Captura de ecrã a mostrar o canto superior direito de um dashboard, com o ícone de estrela destacado a vermelho.](./media/end-user-reading-view/power-bi-favorite-icon.png)

Para ver os favoritos, selecione **Favoritos** no painel de navegação.

![Captura de ecrã a mostrar a Home Page com Favoritos selecionado e destacado a vermelho.](./media/end-user-reading-view/power-bi-list-favorite.png)
...
![menu Vista do relatório](media/end-user-reading-view/power-bi-view-icon.png)
...
Paire o rato sobre um elemento visual e selecione o ícone **Modo de detalhe**![selecionar o Modo de detalhe no menu ](media/end-user-reading-view/pbi_popouticon.jpg). Quando vir uma visualização no Modo de detalhe, esta é expandida para preencher toda a tela do relatório, conforme mostrado abaixo.

![Captura de ecrã a mostrar uma seta a apontar para o ícone de Modo de detalhe.](media/end-user-reading-view/power-bi-fullscreen.png)

![Captura de ecrã a mostra o elemento visual do modo de detalhe a preencher toda a tela.](media/end-user-reading-view/power-bi-fullscreen-after.png)
...
![Captura de ecrã a mostrar o menu pendente Vista.](media/end-user-reading-view/power-bi-focus.png)

![Captura de ecrã a mostrar o mesmo elemento visual no modo de ecrã inteiro.](media/end-user-reading-view/power-bi-full.png)
...
Com um elemento visual ativo, selecione **Mais opções** (...) e escolha **Mostrar como tabela**.
   ...
   ![Captura de ecrã a mostrar um gráfico de área na parte superior e uma tabela com os dados abaixo.](./media/end-user-show-data/power-bi-show-data-table.png)


### <a name="export-data-to-excel"></a>Export data to Excel (Exportar dados para o Excel)
