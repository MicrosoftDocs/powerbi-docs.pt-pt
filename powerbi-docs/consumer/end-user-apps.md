...
Planeia criar uma aplicação? Veja [Criar áreas de trabalho com os seus colegas de trabalho no Power BI](end-user-create-apps.md) para obter mais informações.
...
* [Criar e publicar aplicações no Power BI](end-user-create-apps.md)
