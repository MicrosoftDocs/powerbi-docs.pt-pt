...
* [Introdução às Perguntas e Respostas do Power BI](end-user-q-and-a.md)
...
1. No canto superior direito do Power BI, selecione o ícone da engrenagem ![Ícone de engrenagem](./media/end-user-q-and-a-direct-query/power-bi-cog.png) e selecione **Definições**.
   
   ![Menu Definições](./media/end-user-q-and-a-direct-query/powerbi-settings.png)
2. Selecione **conjuntos de dados** e selecione o conjunto de dados para ativar para as Perguntas e Respostas.
   
   ![Ecrã Conjuntos de dados do menu Definições](./media/end-user-q-and-a-direct-query/power-bi-q-and-a-settings.png)
3. Expanda **Perguntas e Respostas e Cortana**, selecione a caixa de verificação **Ativar as Perguntas e Respostas neste conjunto de dados** e selecione **Aplicar**.
    ...
    ![Área Perguntas e Respostas expandida](./media/end-user-q-and-a-direct-query/power-bi-q-and-a-directquery.png)
...
[Descrição Geral de Perguntas e Respostas do Power BI](end-user-q-and-a.md)  
