...
Com um conjunto de dados de exemplo para executar os passos abaixo, este tutorial mostra-lhe como implementar [**segurança ao nível da linha**](../admin/service-admin-rls.md) num *Modelo de Tabela do Analysis Services* e utilizá-lo num relatório do Power BI.
