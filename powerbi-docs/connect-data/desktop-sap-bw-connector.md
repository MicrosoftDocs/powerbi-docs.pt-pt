...
* Conector SAP para o Microsoft .NET 3.0.22.0 para o Windows 32-bit (x86) ou posterior (.NET Framework 4.0)
* Conector SAP para o Microsoft .NET 3.0.22.0 para o Windows 64-bit (x64) ou posterior (.NET Framework 4.0)
