...
Os pacotes R suportados para o **serviço Power BI** encontram-se na secção seguinte, intitulada **Pacotes Suportados**. Se quiser efetuar um pedido de suporte de um pacote R não encontrado na lista, submeta o seu pedido para o [Power BI Ideas](https://ideas.powerbi.com).
...
* Runtime R atual: Microsoft R 3.4.4
