...
2. Na caixa de diálogo **Feed OData**, cole o URL do feed OData Northwind, `http://services.odata.org/V3/Northwind/Northwind.svc/`. Selecione **OK**.
