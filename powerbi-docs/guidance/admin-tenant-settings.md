---
title: Orientação sobre as definições para administradores de inquilinos
...
Existem duas definições de inquilino relacionadas com a [incorporação de conteúdo do Power BI](../developer/embedding.md). São:
