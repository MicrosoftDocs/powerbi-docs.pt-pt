...
- [Transfira o conjunto de dados do Excel do exemplo de Análise de Revenda](http://go.microsoft.com/fwlink/?LinkId=529778) e guarde-o localmente ou no OneDrive para Empresas.
