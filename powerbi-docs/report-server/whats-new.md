...
Encontre detalhes e exemplos na secção [Utilizar ficheiros .pbids para obter dados](../desktop-data-sources.md#using-pbids-files-to-get-data) do artigo “Origem de dados no Power BI Desktop”.
