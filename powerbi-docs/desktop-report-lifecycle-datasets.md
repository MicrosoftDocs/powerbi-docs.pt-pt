...
Um desafio com a popularidade do Power BI é a proliferação de relatórios, dashboards e os respetivos modelos de dados subjacentes. É fácil criar relatórios apelativos no Power BI Desktop e, em seguida, [publicá-los](desktop-upload-desktop-files.md) no serviço Power BI e criar excelentes dashboards a partir desses conjuntos de dados. Uma vez que muitas pessoas procedem assim, frequentemente com os mesmos (ou praticamente os mesmos) conjuntos de dados, tornou-se num desafio saber que relatório se baseava em qual conjunto de dados e quão recente era cada conjunto de dados. A ligação em direto do serviço Power BI aborda este desafio e torna a criação, partilha e expansão dos relatórios e dashboards de conjuntos de dados comuns mais fáceis e consistentes.
