...
Power BI Desktop está disponível nos mesmos idiomas que o serviço Power BI, exceto hebraico e árabe. O ambiente de trabalho não suporta línguas da direita para a esquerda.
...
1. No serviço Power BI, selecione o ícone **de Definições** ![ Screenshot do serviço Power BI mostrando o ícone Definições.](media/supported-languages-countries-regions/pbi_settings_icon.png) > **Definições**.
2. No **separador Geral,** **selecione Idioma**.
3. Utilize o idioma já definido para o seu navegador ou selecione um idioma separado para o serviço Power BI.  

### <a name="choose-your-language-in-the-browser"></a>Selecionar o seu idioma no browser
O Power BI detecta o idioma com base nas preferências de idioma no seu computador. A maneira de aceder e alterar essas preferências pode variar dependendo do sistema operativo e browser. Eis como aceder a estas preferências a partir do Microsoft Edge e do Google Chrome.

#### <a name="microsoft-edge"></a>Microsoft Edge
1. Selecione as **Definições e mais** elipses (...) a partir do canto superior direito da janela do seu navegador e escolha **Definições**.    
    ![Screenshot de Edge mostrando as Definições e mais ícone.](media/supported-languages-countries-regions/power-bi-setting-icon.png)

1. Selecione o ícone **Definições** no canto superior esquerdo da janela do seu navegador e escolha **Idiomas**.
   
   ![Screenshot de Edge mostrando o botão Definições.](media/supported-languages-countries-regions/power-bi-languages.png)

1. Selecione o seu idioma preferido.

#### <a name="google-chrome-version-87"></a>Google Chrome (versão 87)
1. Selecione o botão de menu no canto superior direito da janela do seu navegador e escolha **Definições**.
   
   ![Captura de ecrã a mostrar o Google Chrome com o botão do menu.](media/supported-languages-countries-regions/power-bi-chrome.png)
 
3. Expandir **Advanced**, e escolher **idiomas.**

    ![Screenshot do Google Chrome mostrando a definição de idiomas.](media/supported-languages-countries-regions/power-bi-chrome-settings.png)

4. Para adicionar um novo idioma, **selecione Adicionar idiomas**.
...
* Quando instala o Power BI Desktop a partir da Windows Store, instala todos os idiomas (atualmente, 42 idiomas) e por predefinição mostra o idioma que corresponde ao idioma padrão do Windows.
...
2. Para alterar o idioma, abra o ambiente de trabalho e no canto superior esquerdo selecione  >  **Opções de Ficheiros e Definições**  >  .    

   ![Screenshot do power BI desktop mostrando o botão Opções.](media/supported-languages-countries-regions/power-bi-desktop-options.png)    

1. Selecione **definições regionais** e defina ou altere as suas preferências linguísticas.
...
3. Selecione **Região** > **Definições adicionais de data, hora e região**. Se não vir esta opção, selecione **Alterar os formatos de dados** e, em seguida, **as definições relacionadas**.
