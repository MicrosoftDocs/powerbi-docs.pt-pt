...
![Diagrama a mostrar capturas de ecrã do Power BI Desktop, o serviço Power BI e Power BI Mobile e as respetivas relações integradas.](media/service-self-service-signup-for-power-bi/power-bi-tools.png)
...
- Selecione **Iniciar a versão gratuita** ou **Experimente gratuitamente** em [powerbi.microsoft.com](https://powerbi.com). Poderá ter de selecionar um botão duas vezes.
    ...
    ![Captura de ecrã a mostrar o serviço Power BI, com o site powerbi.com num browser.](media/service-admin-signing-up-for-power-bi-with-a-new-office-365-trial/power-bi-try.png)    

- Em alternativa, selecione uma ligação num e-mail para um dashboard, relatório ou aplicação do Power BI.

    ![Captura de ecrã a mostrar o serviço Power BI, com um e-mail a ser enviado a partir de powerbi.com.](media/service-self-service-signup-for-power-bi/power-bi-email.png)

1. O Microsoft 365 reconhece-o e sabe que já tem um serviço Microsoft instalado. Selecione **Iniciar sessão**.

    ![Captura de ecrã a mostrar o serviço Power BI, a indicar que a Microsoft reconhece o e-mail.](media/service-admin-signing-up-for-power-bi-with-a-new-office-365-trial/power-bi-sign-up.png)

1. Poderá receber uma destas caixas de diálogo. 
    - Se lhe for pedido, inicie sessão com a sua conta organizacional.

        ![Captura de ecrã a mostrar o serviço Power BI, com um pedido para introduzir o novo endereço de e-mail.](media/service-admin-signing-up-for-power-bi-with-a-new-office-365-trial/power-bi-sign-in.png)
    ...
    - Se receber uma mensagem como esta, certifique-se de que está a utilizar um endereço de e-mail escolar ou profissional e não um endereço de consumidor como hotmail, gmail ou outlook. Veja [Endereços de e-mail suportados](#supported-email-addresses) acima.
       ...
       ![Captura de ecrã a mostrar o serviço Power BI, com um pedido para confirmar o endereço de e-mail.](media/service-self-service-signup-for-power-bi/power-bi-did-you.png)

    - Se receber uma mensagem como esta, veja os termos e condições. Se concordar, selecione **Iniciar**. 

        ![Captura de ecrã a mostrar o serviço Power BI, com o pedido de início de sessão da opção Começar.](media/service-self-service-signup-for-power-bi/power-bi-almost.png)

1. Opcionalmente, convide alguns colegas para se juntarem a si.

   ![Captura de ecrã a mostrar o serviço Power BI, com o ecrã "Convidar mais pessoas".](media/service-admin-signing-up-for-power-bi-with-a-new-office-365-trial/power-bi-friends.png)    
...
1. Neste momento, poderá ter de esperar para ver se a Microsoft está a [configurar um novo inquilino](../admin/service-admin-signing-up-for-power-bi-with-a-new-office-365-trial.md). Caso contrário, será aberto o serviço Power BI no browser.
    ...
    ![Captura de ecrã a mostrar o serviço Power BI com o ecrã principal do Power BI.](media/service-admin-signing-up-for-power-bi-with-a-new-office-365-trial/power-bi-power-bi.png)    
...
![Captura de ecrã a mostrar o serviço Power BI, com a caixa de diálogo da avaliação do Power BI.](media/service-self-service-signup-for-power-bi/power-bi-start-trial.png)
