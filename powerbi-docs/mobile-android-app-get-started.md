...
1. Toque no botão de navegação global ![Botão de navegação global](media/mobile-android-app-get-started/power-bi-android-options-icon.png) no canto superior direito.
...
* Toque na lupa no canto superior direito ![Ícone de pesquisa](media/mobile-android-app-get-started/power-bi-ipad-search-icon.png)e, em seguida, escreva o termo a procurar.
    ...
    ![Resultados de pesquisa](media/mobile-android-app-get-started/power-bi-android-tablet-search.png)
