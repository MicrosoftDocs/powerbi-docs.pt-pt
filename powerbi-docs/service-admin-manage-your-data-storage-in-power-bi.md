...
Os limites de armazenamento das áreas de trabalho, sejam para A Minha Área de trabalho ou uma área de trabalho de aplicação, dependem de se a área de trabalho está numa [capacidade Premium ou partilhada](service-basic-concepts.md#capacities).
...
- Em áreas de trabalho de aplicações, a utilização total não pode exceder os 10 GB multiplicados pelo número de licenças Pro no inquilino.
