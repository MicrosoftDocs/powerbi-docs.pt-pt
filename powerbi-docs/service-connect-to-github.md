...
>[!NOTE]
>A aplicação de modelo necessita de uma conta do GitHub para ter acesso ao repositório. Mais detalhes sobre os requisitos abaixo.
...
Acabou de instalar a sua aplicação de modelo GitHub. Isso significa que criou uma área de trabalho do GitHub. Na área de trabalho, pode alterar o relatório e o dashboard e, em seguida, distribuí-la como uma *aplicação* pelos colegas na sua organização. 

1. Selecione a seta junto ao nome da área de trabalho na barra de navegação à esquerda. Verá que a área de trabalho contém um dashboard e um relatório.
...
3. Para ver todos os conteúdos da sua nova área de trabalho do GitHub, na barra de navegação à esquerda, selecione **Áreas de trabalho** > **GitHub**.
...
2. Selecione **Relatórios** e **Conjuntos de dados** para ver os restantes elementos na área de trabalho.
    ...
    Leia mais sobre como [distribuir aplicações](service-create-distribute-apps.md) pelos seus colegas.
