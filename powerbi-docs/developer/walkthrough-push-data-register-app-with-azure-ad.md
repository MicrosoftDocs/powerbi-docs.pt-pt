...
1. Aceda a dev.powerbi.com/apps.
...
![Registar aplicação](media/walkthrough-push-data-register-app-with-azure-ad/powerbi-developer-sample-register-app.png)
