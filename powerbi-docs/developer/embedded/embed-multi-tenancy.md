---
title: Gerir multi-inquilinos com a análise incorporada do Power BI, que permite melhores informações de BI incorporadas
description: Crie uma aplicação de multi-inquilinos com a análise incorporada do Power BI para permitir melhores informações de BI incorporadas para os seus clientes.
author: KesemSharabi
ms.author: kesharab
