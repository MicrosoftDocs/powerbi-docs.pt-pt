...
description: Saiba como exportar um relatório do Power BI incorporado para melhorar a experiência de análise incorporada do Power BI
author: KesemSharabi
ms.author: kesharab
ms.topic: how-to
ms.service: powerbi
