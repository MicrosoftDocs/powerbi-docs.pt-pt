---
title: Incorporar conteúdos do Power BI numa aplicação de análise incorporada com o principal de serviço e um segredo da aplicação permite melhores informações de BI incorporada
description: Saiba como autenticar-se para obter análises incorporadas com um principal de serviço da aplicação do Azure Active Directory e um segredo da aplicação. Permita melhores informações de BI incorporadas com a análise incorporada do Power BI.
author: KesemSharabi
ms.author: kesharab
ms.reviewer: ''
ms.service: powerbi
...
### <a name="add-a-service-principal-as-a-workspace-member-using-powershell"></a>Adicionar um principal de serviço como membro da área de trabalho no PowerShell

Esta secção inclui um script de exemplo para adicionar um principal de serviço como membro da área de trabalho com o [PowerShell](/powershell/azure/create-azure-service-principal-azureps).
...
### <a name="add-a-security-group-as-a-workspace-member-using-powershell"></a>Adicionar um grupo de segurança como membro da área de trabalho no PowerShell

Esta secção inclui um script de exemplo para adicionar um grupo de segurança como membro da área de trabalho com o [PowerShell](/powershell/azure/create-azure-service-principal-azureps).
