---
title: "Incorporar conteúdo do Power BI numa aplicação para os seus clientes da Administração Pública dos EUA"
...
---
# <a name="embed-a-power-bi-dashboard-tile-or-report-into-your-application-for-us-government"></a>Incorporar um dashboard, mosaico ou relatório do Power BI na sua aplicação da Administração Pública dos EUA
...
Ao contrário da cloud pública, a cloud da Administração Pública dos EUA tem três secções de categorias diferentes.
...
Para começar estas instruções, precisa de uma **conta do Power BI US Government**. Se não tiver uma conta configurada, pode [inscrever-se numa conta de administração pública do Power BI](../service-govus-signup.md).
