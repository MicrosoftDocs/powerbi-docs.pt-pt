...
ms.locfileid: "74700346"
---
# <a name="formatting-utils"></a>Formatting utils (Utilitários de formatação)

Os utilitários de formatação incluem as classes, interfaces e métodos para formatar valores. Também incluem métodos de extensão para processar cadeias e medir o tamanho do texto num documento SVG/HTML.
...
Esta interface descreve as propriedades comuns do texto.
...
Esta função mede a largura do texto com as propriedades do texto SVG fornecidas.

```typescript
function measureSvgTextWidth(textProperties: TextProperties, text?: string): number;
```

Exemplo de utilização de `measureSvgTextWidth`:
...
Esta função devolve um ret. com as propriedades do texto SVG fornecidas.

```typescript
function measureSvgTextRect(textProperties: TextProperties, text?: string): SVGRect;
```

Exemplo de utilização de `measureSvgTextRect`:
...
Exemplo de utilização de `measureSvgTextHeight`:
...
Esta função devolve uma linha de base com as propriedades do texto SVG fornecidas.
...
Esta função estima a altura do texto com as propriedades do texto SVG fornecidas.

```typescript
function estimateSvgTextHeight(textProperties: TextProperties, tightFightForNumeric?: boolean): number;
```

Exemplo de utilização de `estimateSvgTextHeight`:
...
Dê uma vista de olhos ao código de exemplo do elemento visual personalizado [aqui](https://github.com/Microsoft/powerbi-visuals-sankey/blob/4d544ea145b4e15006083a3610dfead3da5f61a4/src/visual.ts#L372).

### <a name="measuresvgtextelementwidth"></a>measureSvgTextElementWidth

Esta função mede a largura de svgElement.

```typescript
function measureSvgTextElementWidth(svgElement: SVGTextElement): number;
```

Exemplo de utilização de measureSvgTextElementWidth:
...
Esta função obtém as propriedades de medição do elemento DOM fornecido.

```typescript
function getMeasurementProperties(element: Element): TextProperties;
```

Exemplo de utilização de `getMeasurementProperties`:
...
Esta função obtém as propriedades de medição do elemento de texto SVG fornecido.

```typescript
function getSvgMeasurementProperties(svgElement: SVGTextElement): TextProperties;
```

Exemplo de utilização de `getSvgMeasurementProperties`:
...
Esta função devolve a largura de um elemento div.

```typescript
function getDivElementWidth(element: JQuery): string;
```

Exemplo de utilização de `getDivElementWidth`:
...
Compara o tamanho do texto das etiquetas com o tamanho disponível e compõe reticências quando o tamanho disponível é menor.

```typescript
function getTailoredTextOrDefault(textProperties: TextProperties, maxWidth: number): string;
```

Exemplo de utilização de `getTailoredTextOrDefault`:
...
## <a name="string-extensions"></a>Extensões de cadeias

O módulo fornece as seguintes funções:

## <a name="endswith"></a>endsWith

Esta função verifica se uma cadeia termina com uma subcadeia.

```typescript
function endsWith(str: string, suffix: string): boolean;
```

Exemplo de utilização de `endsWith`:
...
Esta função compara cadeias, ignorando maiúsculas e minúsculas.

```typescript
function equalIgnoreCase(a: string, b: string): boolean;
```

Exemplo de utilização de `equalIgnoreCase`:
...
Esta função verifica se uma cadeia começa com uma subcadeia;

```typescript
function startsWith(a: string, b: string): boolean;
```

Exemplo de utilização de `startsWith`:
...
Exemplo de utilização do método `contains`:
...
Esta interface descreve os métodos públicos e propriedades do formatador.
...
Este método formata o valor fornecido.
...
#### <a name="the-thousand-formats"></a>Os formatos de milhares
...
#### <a name="the-million-formats"></a>Os formatos de milhões
...
#### <a name="the-billion-formats"></a>Os formatos de milhares de milhões
...
#### <a name="the-trillion-format"></a>Os formatos de biliões
...
#### <a name="the-exponent-format"></a>O formato de expoente
...
### <a name="the-culture-selector"></a>O seletor de cultura
...
#### <a name="the-percentage-format"></a>O formato de percentagem
...
#### <a name="the-dates-format"></a>O formato de datas
...
#### <a name="the-boolean-format"></a>O formato booleano
...
#### <a name="the-customized-precision"></a>A precisão personalizada
...
Dê uma vista de olhos ao código de exemplo do elemento visual personalizado [aqui](https://github.com/Microsoft/powerbi-visuals-sankey/blob/4d544ea145b4e15006083a3610dfead3da5f61a4/src/visual.ts#L359).

## <a name="valueformatteroptions"></a>ValueFormatterOptions

Esta interface descreve `options` do IValueFormatter e as opções da função "criar".
...
Este método cria uma instância de IValueFormatter.
...
### <a name="example-of-using-create"></a>Exemplo de utilização de criação
