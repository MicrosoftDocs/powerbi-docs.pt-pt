...
Para saber mais sobre os elementos visuais baseados em R, veja [Utilizar elementos visuais do Power BI baseados em R no Power BI](../../desktop-r-powered-custom-visuals.md).

Para obter mais informações sobre elementos visuais baseados em linguagem R no Power BI Desktop, veja [Criar elementos visuais do Power BI através da linguagem R](../../desktop-r-visuals.md).
