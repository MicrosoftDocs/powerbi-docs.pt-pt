...
Para **incorporação na sua organização**, veja as seguintes orientações:
...
* [Integrar um relatório na aplicação](embed-sample-for-customers.md)
