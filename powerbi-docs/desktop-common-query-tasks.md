...
Para ver uma demonstração passo a passo da ligação aos dados no Power BI Desktop, veja [Ligar-se aos dados no Power BI Desktop](desktop-connect-to-data.md).

## <a name="shape-and-combine-data"></a>Formatar e combinar dados

Pode formatar e combinar dados facilmente com o Editor do Power Query. Esta secção inclui alguns exemplos sobre como pode formatar dados. Para obter uma demonstração mais completa da formatação e combinação dos dados, veja [Formatar e combinar Dados com o Power BI Desktop](desktop-shape-and-combine-data.md).
