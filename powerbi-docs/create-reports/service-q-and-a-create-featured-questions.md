...
ms.locfileid: "97927187"
---
# <a name="create-featured-questions-for-power-bi-qa"></a>Criar perguntas em destaque para as Perguntas e Respostas do Power BI
Se tiver permissões de edição para um conjunto de dados, pode adicionar as suas próprias perguntas em destaque para esse conjunto de dados. As Perguntas e Respostas do Power BI mostrarão essas perguntas a colegas que consumem dashboards baseados nesse conjunto de dados.  As perguntas em destaque fornecem aos seus colegas algumas ideias sobre os tipos de perguntas que eles podem fazer sobre o conjunto de dados. As perguntas em destaque adicionadas são decididas por si; pode adicionar perguntas populares, perguntas que mostram resultados interessantes ou perguntas que podem ser difíceis de formular.

> [!NOTE]
> As perguntas em destaque das Perguntas e Respostas estão disponíveis na [aplicação Microsoft Power BI em iPads, iPhones e dispositivos iPod Touch](../consumer/mobile/mobile-apps-ios-qna.md) e no serviço Power BI (app.powerbi.com). A criação de perguntas só está disponível no serviço Power BI.
> 
...
5. Escreva a sua pergunta na caixa de texto. Por exemplo, escreva "mostrar as vendas do ano passado por território conforme o mapa de manchas" e selecione **Aplicar**.   Opcionalmente, adicione outra pergunta, ao selecionar **Adicionar uma pergunta** novamente.  
...
7. A nova pergunta em destaque, **mostrar vendas do ano passado por território conforme o mapa de manchas**, é a primeira na lista. Selecione-a.  
