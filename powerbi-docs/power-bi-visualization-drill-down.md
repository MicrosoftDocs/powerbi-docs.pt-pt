...
2. Compreender a forma como os vários ícones de desagregação funcionam em conjunto pode ser confuso, por isso iremos filtrar o treemap para apresentar apenas dois dos territórios mais pequenos: **KY** e **TN**. Selecione o treemap e, em **Filtros de nível visual**, expanda **Território** e selecione **KY** e **TN**.
   ...
   ![Ícone de desagregação duplo](media/power-bi-visualization-drill-down/power-bi-territories.png)
...
- Coloque o cursor sobre uma visualização para ver e utilizar os ícones.  
    ...
    ![Caminho de desagregação](media/power-bi-visualization-drill-down/power-bi-hover.png)
...
![Caminho de desagregação](media/power-bi-visualization-drill-down/power-bi-drill-path.png)
...
![Caminho de expansão](media/power-bi-visualization-drill-down/power-bi-expand-path.png)
...
1. Comece pelo nível superior do treemap que apresenta dados para KY e TN. Alargue o treemap ao selecionar uma das alças e ao arrastar para a direita. 
    ...
    ![Treemap a apresentar dois estados](media/power-bi-visualization-drill-down/power-bi-drill-down.png) .

2. Para desagregar ***todos os campos de uma vez***, selecione a seta dupla no canto superior esquerdo da visualização ![Ícone de desagregação duplo](media/power-bi-visualization-drill-down/power-bi-drill-icon3.png). O treemap mostra agora dados de cidade para Kentucky e Tennessee. 

    ![Ícone de desagregação duplo](media/power-bi-visualization-drill-down/power-bi-drill-down1.png)
   
5. Desagregue mais uma vez até ao nível Código Postal da hierarquia.

    ![Ícone de desagregação duplo](media/power-bi-visualization-drill-down/power-bi-drill-down2.png)

3. Para voltar a agregar, selecione a seta para cima no canto superior esquerdo da visualização ![](media/power-bi-visualization-drill-down/power-bi-drill-icon5.png).
...
1. Selecione o ícone de desagregação para o ativar ![Desagregação ativada](media/power-bi-visualization-drill-down/power-bi-drill-icon2.png). Agora tem a opção de desagregar ***um campo de cada vez***. 
...
1. Com o treemap ativo, selecione o ícone *Expandir para baixo* ![Ícone Expandir para baixo](media/power-bi-visualization-drill-down/power-bi-drill-icon6.png). O treemap mostra agora dois níveis da hierarquia: Código Postal e Nome da loja. 

    ![Apresentação do código postal e do nome da loja](media/power-bi-visualization-drill-down/power-bi-expand1.png)
...
3. Certifique-se de que a desagregação continua ativada ![desagregação ativada](media/power-bi-visualization-drill-down/power-bi-drill-icon2.png) e selecione o ícone *Expandir para baixo* ![Ícone Expandir para baixo](media/power-bi-visualization-drill-down/power-bi-drill-icon6.png). O treemap apresenta agora alguns detalhes adicionais. Em vez de apresentar apenas a cidade e o estado, apresenta agora também o código postal. 

    ![Ícone de desagregação duplo](media/power-bi-visualization-drill-down/power-bi-expand-one3.png)
...
4. Selecione novamente o ícone *Expandir para baixo* para apresentar os quatro níveis de detalhe da hierarquia para Tennessee no treemap. Coloque o cursor sobre uma folha para ver ainda mais detalhes.
   ...
   ![Treemap a apresentar dados para Tennessee](media/power-bi-visualization-drill-down/power-bi-expand-all.png)
...
1. No Power BI Desktop, selecione o separador **Formato** e a caixa de verificação **Desagregar filtra outros elementos visuais**.
    ...
    ![Definição no Power BI Desktop](media/power-bi-visualization-drill-down/power-bi-drill-filters-desktop.png)
...
2. Agora, quando desagregar (ou agregar ou expandir) um elemento visual com uma hierarquia, esta ação filtrará os outros elementos visuais na página. 
    ...
    ![Definição no Power BI Desktop](media/power-bi-visualization-drill-down/power-bi-drill-filters.png)

    ![Definição no Power BI Desktop](media/power-bi-visualization-drill-down/power-bi-drill-filters2.png)
...
>
> ![Definição no serviço Power BI](media/power-bi-visualization-drill-down/power-bi-drill-filters-service.png)
