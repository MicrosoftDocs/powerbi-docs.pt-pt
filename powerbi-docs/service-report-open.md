...
1. Selecione o nome do relatório para o abrir na Vista de leitura.  
   
    ![](media/service-report-open/power-bi-reading-view.png)
1. Há [muita coisa que pode fazer na Vista de Leitura](service-reading-view-and-editing-view.md).  Este relatório de exemplo tem várias páginas, por isso, comece a explorá-las ao selecionar cada separador na parte inferior da tela do relatório. 
