...
2. Instale as ferramentas de linha de comandos. Execute o seguinte comando numa linha de comandos.
...
## <a name="enable-a-live-preview-of-the-developer-visual"></a>Ativar a pré-visualização em direto do elemento visual do programador
...
![Seleção do elemento visual do programador do Power BI](media/service-custom-visuals-getting-started-with-developer-tools/powerbi-developer-visual-selection.png)
