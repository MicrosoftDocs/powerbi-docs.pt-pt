...
O local onde armazena os ficheiros também faz muita diferença. O OneDrive para Empresas fornece maior nível de flexibilidade e integração com o Power BI. Se mantiver os ficheiros na unidade local, não haverá qualquer problema. Mas se precisar de atualizar os dados, terá de seguir alguns passos adicionais. Serão fornecidos mais detalhes nos artigos ligados.
...
Verá os termos utilizados com muita frequência pelo conjunto de dados e pela origem de dados no Power BI. Geralmente, são usados como sinónimos, mas na verdade são duas coisas diferentes, embora relacionadas.
