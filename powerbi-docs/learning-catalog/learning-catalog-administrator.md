...
description: Descubra todas as opções de preparação do Power BI para administradores, desde as mais básicas às mais avançadas.
author: margoc
ms.author: margoc
ms.prod: powerbi
ms.topic: article
...
## <a name="administer"></a>Administrar<a name="administer"></a>
| Conteúdo | Descrição  | Formatar | Comprimento |
|-------------------------------------------------------------------------------------|---------------------------------------------------------------------|--------|--------|
