...
description: Saiba mais sobre os relatórios paginados no serviço Power BI. Saiba mais sobre as regras utilizadas para controlar a paginação na composição de um relatório que é otimizado para o compositor que pretende utilizar.
author: maggiesMSFT
ms.author: maggies
ms.reviewer: ''
ms.service: powerbi
...
## <a name="page-breaks-and-page-names"></a>Quebras de página e nomes de página
 ...
 Se o relatório tiver nomes de página, provavelmente é mais fácil ler o relatório e auditar e exportar os respetivos dados. O Report Builder fornece propriedades para estes itens:

- relatórios
- tabelas, matrizes e listas de regiões de dados
- grupos
- retângulos no relatório para controlar a paginação, repor os números de página e fornecer novos nomes de página do relatório nas quebras de página. 
 
Estas funcionalidades podem melhorar os relatórios independentemente do formato no qual os relatórios são compostos. São especialmente úteis quando exporta relatórios para livros do Excel.
