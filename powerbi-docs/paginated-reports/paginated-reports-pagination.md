...
description: Saiba mais sobre os relatórios paginados no serviço Power BI e as regras utilizadas para controlar a paginação para conceber um relatório otimizado para o compositor que planeia utilizar.
author: maggiesMSFT
ms.author: maggies
ms.reviewer: ''
ms.service: powerbi
