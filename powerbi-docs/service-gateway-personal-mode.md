...
* Posso executar o **gateway de dados no local (modo pessoal)** como um serviço?
  ...
  * **Resposta:** Não. o **gateway de dados no local (modo pessoal)** só pode ser executado como uma aplicação. Se precisa de executar o gateway como um serviço e/ou no modo de administrador, terá de considerar o [**gateway de dados no local**](service-gateway-onprem.md) (anteriormente conhecido como o gateway Empresarial).
* Com que frequência o **gateway de dados no local (modo pessoal)** é atualizado?
...
* Estou a utilizar o script R. É suportado?
  ...
  * **Resposta**: Estamos a prever adicionar suporte para scripts R em breve.
