...
> [!NOTE]
> Pode inscrever-se no Power BI com endereços .gov ou .mil. Para obter mais informações, veja [Enroll your US Government organization in the Power BI service](https://docs.microsoft.com/power-bi/service-govus-signup) (Inscrever a sua organização do Governo dos EUA no serviço Power BI).
>

> [!NOTE]
> Após a inscrição, pode [convidar utilizadores](https://docs.microsoft.com/azure/active-directory/active-directory-b2b-what-is-azure-ad-b2b) para verem conteúdo no seu inquilino do Power BI com qualquer endereço de e-mail, incluindo contas pessoais.
>
