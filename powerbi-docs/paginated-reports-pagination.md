...
ms.locfileid: "68624846"
---
# <a name="pagination-in-power-bi-paginated-reports"></a>Paginação nos relatórios paginados do Power BI

 A paginação diz respeito ao número de páginas num relatório e à forma como os itens de relatório são apresentados nestas páginas. A paginação nos relatórios paginados do Power BI varia consoante a extensão de composição utilizada para ver e apresentar o relatório. Quando executa um relatório no servidor de relatórios, o relatório utiliza o compositor de HTML. HTML segue um conjunto específico de regras de paginação. Se exportar o mesmo relatório para PDF, por exemplo, é utilizado o compositor de PDF e é aplicado um conjunto diferente de regras. Assim, o relatório é paginado de forma diferente. Para conceber com êxito um relatório de fácil leitura para os utilizadores que é otimizado para o compositor que tenciona utilizar para apresentar o relatório, tem de compreender as regras utilizadas para controlar a paginação nos relatórios paginados do Power BI.  
  
 Este tópico aborda o impacto que o tamanho da página física e o esquema do relatório têm na forma como os compositores de quebras de página manuais compõem o relatório. Pode definir propriedades para modificar o tamanho e as margens da página física e dividir o relatório em colunas através do painel **Report Properties** (Propriedades do Relatório), do painel **Properties** (Propriedades) ou da caixa de diálogo **Page Setup** (Configuração da Página). Para aceder ao painel **Report Properties** (Propriedades do Relatório), clique na área azul fora do corpo do relatório. Para aceder à caixa de diálogo **Page Setup** (Configuração da Página), clique em **Run** (Executar) no separador Home e, em seguida, clique em **Page Setup** (Configuração da Página) no separador Run (Executar).  
...
## <a name="the-physical-page"></a>Página física  
 O tamanho da página física é o tamanho do papel. O tamanho do papel que especifica para o relatório controla a forma como o relatório é composto. Os relatórios compostos em formatos de quebras de página manuais inserem quebras de página na horizontal e na vertical com base no tamanho da página física para proporcionar uma experiência de leitura otimizada quando o relatório é impresso ou visualizado num formato de ficheiro de quebras de página manuais. Os relatórios compostos em formatos de quebras de página flexíveis inserem quebras de página na horizontal com base no tamanho da página física para proporcionar uma experiência de leitura otimizada quando o relatório é visualizado num browser.  
  
 Por predefinição, o tamanho da página é de 8,5 x 11 polegadas, mas pode alterar este tamanho no painel **Report Properties** (Propriedades do Relatório) ou na caixa de diálogo **Page Setup** (Configuração da Página), ou alterar as propriedades PageHeight (Altura da página) e PageWidth (Largura da página) no painel **Properties** (Propriedades). O tamanho da página não aumenta nem diminui para abranger os conteúdos do corpo do relatório. Se quiser que o relatório seja apresentado numa única página, todos os conteúdos dentro do corpo do relatório têm de ficar ajustados na página física. Se não ficarem ajustados e utilizar o formato de quebras de página flexíveis, o relatório precisará de páginas adicionais. Se o corpo do relatório aumentar além da margem direita da página física, é inserida uma quebra de página na horizontal. Se o corpo do relatório aumentar além da margem inferior da página física, é inserida uma quebra de página na vertical.  
