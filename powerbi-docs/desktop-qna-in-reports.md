...
> [!NOTE]
> As Perguntas e Respostas só estão disponíveis quando trabalha com um modelo que tenha dados **importados** ou em ligações em Direto para SSAS. Os modelos DirectQuery não são suportados.
>
