...
![Captura de ecrã a mostrar as definições Opções para Enviar Dados de Utilização.](media/desktop-privacy/privacy_01.png)
...
![Captura de ecrã a mostrar a caixa de diálogo Falha de sistema, com as opções para comunicar o problema ou fechar.](media/desktop-privacy/privacy_02.png)
