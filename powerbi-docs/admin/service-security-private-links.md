...
ms.locfileid: "92349443"
---
# <a name="private-links-for-accessing-power-bi"></a>Ligações privadas para aceder ao Power BI

A rede do Azure fornece duas funcionalidades de segurança (Ligações Privadas do Azure e Pontos Finais Privados) que permitem ao Power BI fornecer acesso seguro. Com as Ligações Privadas do Azure e os Pontos Finais Privados, o tráfego de dados é enviado de forma privada através da infraestrutura de rede principal da Microsoft e, desta forma, os dados não percorrem a Internet. 
