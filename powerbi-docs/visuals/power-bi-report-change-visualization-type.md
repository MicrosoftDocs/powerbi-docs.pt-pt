...
3. No painel de Visualizações, selecione o novo tipo de visualização. 
   ...
   ![Vídeo a mostrar a alteração de um gráfico de colunas para um gráfico de linhas](media/power-bi-report-change-visualization-type/changeviz.gif).
